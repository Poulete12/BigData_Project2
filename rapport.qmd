...
Les violons montrent que les nouvelles intègrent proportionnellement le plus de discours direct (médiane ≈ 0,08 %), tandis que les romans restent majoritairement narratifs (< 0,23 %), montrant une stratégie énonciative différenciée selon le genre.
